#ifndef COMMON_VIDEO_RECORDER_HPP_
#define COMMON_VIDEO_RECORDER_HPP_
...
class VideoRecorder {
 public:
  ...
  void PushFrame(std::shared_ptr<Buffer> frame);
 ...
 private:
  ...
  std::deque<std::shared_ptr<Buffer>> ring_buffer_;
...
#endif  // COMMON_VIDEO_RECORDER_HPP_
